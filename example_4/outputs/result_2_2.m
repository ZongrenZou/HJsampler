...
h = legend([h2, h1, h3], ["Mean", "2 SD", "$y_2$"], "interpreter", "latex");
...
title("$P(Y_{0.9}|Y_T = y_2)$", "fontsize", 12, "interpreter", "latex")
% xlim([0, 1])
ylim([-0.4, 1])
box(ax1, "on")
box(ax2, "on")
...
exportgraphics(gcf, "fig2_1.png", 'Resolution', 300)
close
...
xlabel(ax1, "$x$", "fontsize", 10, "interpreter", "latex")
xlabel(ax2, "Index", "fontsize", 10, "interpreter", "latex")
title("$P(Y_{0.5}|Y_T = y_2)$", "fontsize", 12, "interpreter", "latex")
% xlim([0, 1])
ylim([-0.4, 1])
box(ax1, "on")
box(ax2, "on")

exportgraphics(gcf, "fig2_2.png", 'Resolution', 300)
close
...
xlabel(ax1, "$x$", "fontsize", 10, "interpreter", "latex")
xlabel(ax2, "Index", "fontsize", 10, "interpreter", "latex")
title("$P(Y_{0.2}|Y_T = y_2)$", "fontsize", 12, "interpreter", "latex")
% xlim([0, 1])
ylim([-0.4, 1])
box(ax1, "on")
box(ax2, "on")

exportgraphics(gcf, "fig2_3.png", 'Resolution', 300)
close
...
xlabel(ax1, "$x$", "fontsize", 10, "interpreter", "latex")
xlabel(ax2, "Index", "fontsize", 10, "interpreter", "latex")
title("$P(Y_{0.1}|Y_T = y_2)$", "fontsize", 12, "interpreter", "latex")
% xlim([0, 1])
ylim([-0.4, 1])
box(ax1, "on")
box(ax2, "on")

exportgraphics(gcf, "fig2_4.png", 'Resolution', 300)
close
...
xlabel(ax1, "$x$", "fontsize", 10, "interpreter", "latex")
xlabel(ax2, "Index", "fontsize", 10, "interpreter", "latex")
title("$P(Y_{0}|Y_T = y_2)$", "fontsize", 12, "interpreter", "latex")
% xlim([0, 1])
ylim([-0.4, 1])
box(ax1, "on")
box(ax2, "on")

exportgraphics(gcf, "fig2_5.png", 'Resolution', 300)
